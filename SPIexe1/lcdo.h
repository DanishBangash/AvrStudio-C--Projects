...
// ports for definations
#define LCD_PRT  	PORTA // LCD data Port
#define LCD_DDR		DDRA  //LCD data direction
...
// Functions PROTOTYPES
 ...
 void lcdCommand (unsigned char cmnd); // for sending command 
 void lcdData(unsigned char data);     // for data trasmission
 void lcd_init(); 					   //initialization of port for lcd
 void lcd_gotoxy(unsigned char x, unsigned char y);	 // columns and rows
 void lcd_print(char *str);            // print the string*/
